	...
	public void update() {
		...
		*/
		...
		if (PlayerTele(x,y, level, player)) {
			...
			if (isRandom) {
			while(!level.returnTileXY(level.tile, sx, sy).toString().equals(level.tile.Wood.toString()) && !level.returnTileXY(level.tile, sx, sy).toString().equals(level.tile.CobbleStone.toString())) {
