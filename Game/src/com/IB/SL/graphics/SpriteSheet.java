...
public class SpriteSheet {
	...
	public static SpriteSheet statPoints = new SpriteSheet("/Textures/sheets/01_GUI/Menu/Inventory/statPoints.png", 136, 104);
...
//	public static SpriteSheet water_anim = new SpriteSheet(blocks, 0, 6, 3, 1, 16);
	...
	public static SpriteSheet healthbar = new SpriteSheet("/Textures/sheets/01_GUI/HUD/HealthEx.png", 32, 704);
	public static SpriteSheet anim_hb = new SpriteSheet(healthbar, 0, 0, 1, 21, 32);
	
	public static SpriteSheet manabar = new SpriteSheet("/Textures/sheets/01_GUI/HUD/ManaEx.png", 32, 704);
	public static SpriteSheet anim_mb = new SpriteSheet(manabar, 0, 0, 1, 21, 32);

	public static SpriteSheet StaminaBar = new SpriteSheet("/Textures/sheets/01_GUI/HUD/StaminaEx.png", 32, 704);
	public static SpriteSheet anim_sb = new SpriteSheet(StaminaBar, 0, 0, 1, 21, 32);
