...
public class Alice extends Mob{
	 ...
	 private AnimatedSprite down = new AnimatedSprite(SpriteSheet.Alice_down, 16, 16, 3);
	 private AnimatedSprite up = new AnimatedSprite(SpriteSheet.Alice_up, 16, 16, 3);
	 private AnimatedSprite left = new AnimatedSprite(SpriteSheet.Alice_left, 16, 16, 2);
	 private AnimatedSprite right = new AnimatedSprite(SpriteSheet.Alice_right, 16, 16, 2);
