...
public class Guard extends Mob{
	 ...
	 private AnimatedSprite down = new AnimatedSprite(SpriteSheet.Guard_down, 16, 16, 3);
	 private AnimatedSprite up = new AnimatedSprite(SpriteSheet.Guard_up, 16, 16, 3);
	 private AnimatedSprite left = new AnimatedSprite(SpriteSheet.Guard_left, 16, 16, 5);
	 private AnimatedSprite right = new AnimatedSprite(SpriteSheet.Guard_right, 16, 16, 5);
	 ...
	 public TileCoord p1; //= new TileCoord(43, 75);
	 public TileCoord p2; //= new TileCoord(60, 75);
	 public boolean p1Bx = true, p2Bx = false;
	 public boolean p1By = true, p2By = false;
