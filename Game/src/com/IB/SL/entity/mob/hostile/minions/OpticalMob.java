...
public class OpticalMob extends Mob {
	...
	private AnimatedSprite down = new AnimatedSprite(SpriteSheet.Optical_down,
			16, 16, 3);
	private AnimatedSprite up = new AnimatedSprite(SpriteSheet.Optical_up, 16,
			16, 3);
	private AnimatedSprite right = new AnimatedSprite(SpriteSheet.Optical_left,
			16, 16, 2);
	private AnimatedSprite left = new AnimatedSprite(
			SpriteSheet.Optical_right, 16, 16, 2);
