...
public class PoisonZombie extends Mob{
	...
	private AnimatedSprite down = new AnimatedSprite(SpriteSheet.pzombie_down, 16, 16, 3);
	private AnimatedSprite up = new AnimatedSprite(SpriteSheet.pzombie_up, 16, 16, 3);
	private AnimatedSprite left = new AnimatedSprite(SpriteSheet.pzombie_left, 16, 16, 2);
	private AnimatedSprite right = new AnimatedSprite(SpriteSheet.pzombie_right, 16, 16, 2);
	private GUI gui;
