...
public class Siphon extends Mob {
	...
	private AnimatedSprite down = new AnimatedSprite(SpriteSheet.Siphon_down,
			16, 16, 2);
	private AnimatedSprite up = new AnimatedSprite(SpriteSheet.Siphon_up, 16,
			16, 2);
	private AnimatedSprite left = new AnimatedSprite(SpriteSheet.Siphon_left,
			16, 16, 2);
	private AnimatedSprite right = new AnimatedSprite(
			SpriteSheet.Siphon_right, 16, 16, 2);
	...
	public void render(Screen screen) {
		if (this.mobhealth < this.maxhealth) screen.renderSprite((int) x - 16, (int)y - 25, gui.renderMobHealthExperiment(this, 20), true);
		this.xOffset = -8;
		this.yOffset = -15;
