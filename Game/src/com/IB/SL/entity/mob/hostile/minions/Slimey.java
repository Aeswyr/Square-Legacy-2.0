...
public class Slimey extends Mob {
	...
	private AnimatedSprite down = new AnimatedSprite(SpriteSheet.Slimey_down,
			16, 16, 0);
	private AnimatedSprite up = new AnimatedSprite(SpriteSheet.Slimey_up, 16,
			16, 0);
	private AnimatedSprite left = new AnimatedSprite(SpriteSheet.Slimey_left,
			16, 16, 0);
