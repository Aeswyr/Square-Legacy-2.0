...
public class Slime extends Mob {
	...
	private AnimatedSprite down = new AnimatedSprite(SpriteSheet.Slime_down,
			16, 16, 0);
	private AnimatedSprite up = new AnimatedSprite(SpriteSheet.Slime_up, 16,
			16, 0);
	private AnimatedSprite left = new AnimatedSprite(SpriteSheet.Slime_left,
			16, 16, 0);
	private AnimatedSprite right = new AnimatedSprite(SpriteSheet.Slime_right, 16, 16, 0);
