...
public class CopperGuardian extends Mob {
	...
	private AnimatedSprite Main = new AnimatedSprite(SpriteSheet.CopperGuardian_Main, 128, 96, 4);
/*	private AnimatedSprite up = new AnimatedSprite(SpriteSheet.Occulus_up, 32, 32, 0);
	...
	private AnimatedSprite animSprite = Main;
	double xa = 0;
	double ya = 0;
	int xx = 0;
	int yy = 0;
...
private int spin = 0;
	...
	public void render(Screen screen) {
		...
		font.render((int) (x - 75), (int) (y - 105), -5, 0, this.name + ":" + (int)this.mobhealth, screen, true, false);
		//circle();
