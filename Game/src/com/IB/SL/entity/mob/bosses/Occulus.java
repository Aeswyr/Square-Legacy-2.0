...
public class Occulus extends Mob {
	...
	private AnimatedSprite down = new AnimatedSprite(SpriteSheet.Occulus_down, 32, 32, 0);
	...
	public void render(Screen screen) {
		...
		font.render((int) (x - 60), (int) (y - 30), -5, 0, this.name + ":" + (int)this.mobhealth, screen, true, false);
