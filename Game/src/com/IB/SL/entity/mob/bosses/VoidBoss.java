...
public class VoidBoss extends Mob {
	...
	private AnimatedSprite down = new AnimatedSprite(SpriteSheet.VoidBoss_down, 64, 64, 2);
	private AnimatedSprite up = new AnimatedSprite(SpriteSheet.VoidBoss_up, 64, 64, 2);
	private AnimatedSprite left = new AnimatedSprite(SpriteSheet.VoidBoss_left, 64, 64, 2);
	private AnimatedSprite right = new AnimatedSprite(SpriteSheet.VoidBoss_right, 64, 64, 2);
	...
	public void render(Screen screen) {
		...
		font.render((int) (x - 80), (int) (y - 50), -5, 0xffFFFFFF, this.name + ":" + (int)this.mobhealth, screen, true, false);
		//circle();
