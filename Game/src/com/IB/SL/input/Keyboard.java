...
public class Keyboard implements KeyListener {
	...
	private final int numOfKeys = 200;
	...
	public boolean a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, enter, backspace, delete, tab, ctrl, arrow_Left, arrow_Right; 
	...
	public void update() {
		...
		gs1 = keys[KeyEvent.VK_NUMPAD1];
		gs2 = keys[KeyEvent.VK_NUMPAD2];
		gs3 = keys[KeyEvent.VK_NUMPAD3];
		gs4 = keys[KeyEvent.VK_ESCAPE];
		map = keys[KeyEvent.VK_M];
		capture = keys[KeyEvent.VK_F2];
